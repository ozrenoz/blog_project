                    ...
                    <div class="post col-xl-6">
                        ...
                        <div class="post-details">
                            <div class="post-meta d-flex justify-content-between">
                                ...
                                <div class="category"><a href="{{ route('category', ['category' => $post->category]) }}">{{ $post->category->name }}</a></div>
                            </div>
                            <a href="{{ $post->url() }}">
                                <h3 class="h4">{{ $post->heading }}</h3>
                            </a>
                            <p class="text-muted">{{ Str::limit($post->post_description, 100) }}</p>
